...
![Code Server app in the Interactive Apps menu](docs/hpc/09_ood/static/code_server.png)
...
![Code Server Configuration](docs/hpc/09_ood/static/code_server_configuration.png)
...
![Code Server Job](docs/hpc/09_ood/static/code_server_job.png)
