...
:::
:::info
Torch supports NFSv4 ACLs rather than the POSIX ACLs supported by the retired Greene cluster! NFSv4 ACLs allow for more fine grained control when compared to POSIX ACLs.
:::
...
The above would allow kevin to have read, write, and execute access for *all directories* and files inside `/scratch/susie/share`
