...
-   From NYU-net and the High Speed Research Network: use SSH to the DTN hostname of `dtn.torch.hpc.nyu.edu` which resolves to either `dtn011.hpc.nyu.edu` or `dtn012.hpc.nyu.edu` 
