...
As mentioned elsewhere in our documentation, a common problem for our users is that of filling their `/home` directories by using common tools like VSCode, Cursor, R, etc.  They all put a dot directory in your `/home` directory and it can quickly overwhelm your quota.
