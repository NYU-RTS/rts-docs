...
Command line experience is necessary for this lesson. We recommend the participants to go through our [Introduction to Using the Shell on Greene](../12_tutorial_intro_shell_hpc/01_intro.mdx) tutorial, if new to the command line (also known as terminal or shell).
:::

:::note[Objectives]
By the end of this tutorial, students will know how to:
