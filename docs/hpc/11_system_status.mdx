...
<iframe src="https://graphs-out.hpc.nyu.edu/d/vA6e2Kgnk/torch-cluster-load-by-partitions-nyu-hpc-public?orgId=1&theme=light&refresh=30m&from=now-14h&to=now-5m&kiosk=tv" width="100%" height="1000"></iframe>
