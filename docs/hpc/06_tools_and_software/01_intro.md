...
:::tip
We strongly advise that you setup your own computational environments via Apptainer containers and overlay files. Detailed documentation is available in the [containers section](../07_containers/01_intro.md).
:::
